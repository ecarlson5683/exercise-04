...
play_wordle <- function(solution, valid_list, num_guesses =6){
  Print("Hi! Welcome to Wordle. You have 6 tries to guess a 5-letter word that has been selected at random from a list of possible words. Guesses should not include swear words.")
   print(paste("You have", num_guesses, "chances to guess the word"))
  Print
}
