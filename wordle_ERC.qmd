...
play_wordle <- function(solution, valid_list, num_guesses=6){
  ...
  cat("You have", num_guesses, "chances to guess a", n_length, "letter word. ") # Create a string for rules sentence with modifiable guess number and word length, then output. Alternative to `print(paste0())`
  
  # Display letters left (updated with guessed letters, Step 4.5)
  letters_left <- if(i == 1){LETTERS
  } else {letters_left}
...
evaluate_guess <- function(guess, solution){
  ...
  output <- case_when(guess_letters[] == solution[] ~ "*",
