...
```{r}
valid_file <- "https://raw.githubusercontent.com/difiore/ada-2024-datasets/main/collins-scrabble-words-2019.txt"

solution_file <- "https://raw.githubusercontent.com/difiore/ada-2024-datasets/main/google-10000-english-usa-no-swears.txt"
```
...
Additionally, we also need to establish a dictionary of "valid" words that players can guess, and for that we will use the list of Official Scrabble Words.
...
load_dictionary <- function(filename){
  library(tidyverse)
  read_csv(filename, col_names=TRUE) %>% # create data frame
    pull(1) # extract vector of first column in data frame
}

valid_list <- load_dictionary(valid_file)
solution_list <- load_dictionary(solution_file)
